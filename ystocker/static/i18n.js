...
const I18n = (() => {
  ...
  const LANGS = {
    ...
    'dcx.search_note':  { en: 'Any listed symbol works, not just the ranked ones — a name that has not been scored yet builds on first open, which takes a minute. Suggestions cover the tracked universe; anything else, just type the symbol.',
                          zh: '任何上市代码都可以，不限于榜单内的股票 — 尚未评分的公司会在首次打开时构建，约需一分钟。联想仅覆盖已跟踪的范围；其他代码直接输入即可。' },
